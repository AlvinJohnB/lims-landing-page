      ...
      >
        ...
        <div className="container mx-auto text-center max-w-4xl relative z-20">
          ...
          <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto drop-shadow">
            Manage test records, track orders, and streamline your lab—all with
            a fast, secure system built for your workflow.
          </p>
        ...
        <div className="container mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <Card className="border-0 shadow-lg hover:shadow-2xl transition-shadow">
              ...
              <CardContent>
                <p className="text-gray-600">
                  Clean, intuitive design that your team will love to use every
                  day.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-lg hover:shadow-2xl transition-shadow">
              ...
              <CardContent>
                <p className="text-gray-600">
                  Keep your sensitive patient data secure with local deployment
                  options.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-lg hover:shadow-2xl transition-shadow">
              ...
              <CardContent>
                <p className="text-gray-600">
                  Manage team permissions and access levels for different roles
                  in your lab.
                </p>
              </CardContent>
            </Card>
      ...
      >
        <div className="container mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">Flexible subscription plans</p>
          </div>
